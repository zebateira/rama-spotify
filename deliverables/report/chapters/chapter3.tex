...
Next, the available tools will be analysed in order to determine which ones fit the proposed modules to be developed, mostly through experiments. 
...
\label{sec:spotify}
  ...
  The service has several types of clients available to the users: desktop client, webplayer and mobiles applications.
