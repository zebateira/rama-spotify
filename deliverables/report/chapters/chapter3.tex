...
\label{sec:technologies}
  ...
  \label{sub:subsection_name}
    ...
    \lstinputlisting[caption={manifest.json: \emph{BundleIdentifier} is the application's identifier; \emph{Dependencies} declares the Application's API dependencies.}]{snippets/manifest.json}
  ...
  \label{sub:npm}
    ...
    \lstinputlisting[caption={\emph{package.json}: "*" means that npm should always install the latest version of that package.}]{snippets/package.json}
