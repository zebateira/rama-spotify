...
\label{sec:implementation}
  ...
  \subsection{Development Processes} % (fold)
    ...
    \begin{figure}
      \begin{center}
        \includegraphics[width=\textwidth]{code_progress.pdf}
      \end{center}
...
\label{sec:validation}
  ...
  \label{sub:data_analysis}
    ...
    This is the ultimate question that leaves the user thinking if RAMA in fact a usable way of discovering new music.
      ...
      \label{ssub:question_4}
        ...
        In a scale of 1 to 5, give 1 to be "I felt the app was out of place" and 5 to be "I felt the app was part of Spotify", the users were asked to grade the application's integration into Spotify.
