...
\label{sec:prototype}
  ...
  \subsection{Implemented Features} % (fold)
    ...
    The main implemented features of RAMA's Spotify Application are: visualization of a map of a network of connected artists; edition of the visualization parameters; edition of the graph (expand and new map functions); Tags overlay and music artist info.
