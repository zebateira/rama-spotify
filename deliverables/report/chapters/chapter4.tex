...
\label{sec:validation}
  ...
  \label{sub:data_analysis}
    ...
    \label{ssub:question_1}
      ...
      By searching for the new artist, the user can only then drag and drop the artist into the application in the right side menu, or start playing a song from that artist, and then go back to RAMA and click the \emph{new map} button in the artist menu.
    ...
    \label{ssub:question_3}
      ...
      % too much speculation? find refs?
