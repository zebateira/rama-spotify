...
\label{sec:prototype}
  ...
  \subsection{Main Features} % (fold)
    ...
    The main features of RAMA's Spotify Application are: visualization of a map of a network of connected artists; edit the graph (expand and new map functions); Tags overlay and music artist info.
