...
\label{sec:prototype}
  ...
  \subsection{Main Features} % (fold)
    ...
    \subsubsection{Artist Info} % (fold)
      ...
      No official documentation was found to explain what do these values represent, but Paul Lamere explains\footnote{thread in the forum for Echonest's API users - \url{http://developer.echonest.com/forums/thread/353}} that:
  ...
  \subsection{Development Process} % (fold)
    ...
    Incrementally, they were implemented and added to the application\footnote{a timeline with the added features can be seen in \url{https://github.com/carsy/rama-spotify/releases}}.
