...
\label{sec:implementation}
  ...
  \subsection{Development Processes} % (fold)
    ...
    \begin{figure}
      ...
      \end{center}
      \caption{Graph showing the additions and deletions of lines of code to the project from February to June, 2014. All of the development code was hosted in \url{Github.com}. Adapted from \url{https://github.com/carsy/rama-spotify/graphs/code-frequency}}
