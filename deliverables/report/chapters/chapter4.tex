...
\label{sec:prototype}
  ...
  \subsection{Development Process} % (fold)
    ...
    A timeline (chronological order from bottom to top) with the added features can be seen in \\ 
    \indent \url{https://github.com/carsy/rama-spotify/releases}.

    % TODO refer the alfa and beta testers:
    % the iterative process of alfa testing
    % and beta testing
