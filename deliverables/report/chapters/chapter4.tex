...
\label{sec:prototype}
  ...
  \subsection{Main Features} % (fold)
    ...
    \subsubsection{Artist Info} % (fold)
      ...
      The connection between the two APIs is possible thanks to the Project Rosetta Stone\footnote{http://developer.echonest.com/docs/v4\#project-rosetta-stone}.
      ...
      No official documentation was found to explain what do these values represent, but Paul Lamere explains\footnote{thread in the forum for Echonest's API users - http://developer.echonest.com/forums/thread/353} that:
