...
\label{sec:validation}
  ...
  \label{sub:data_analysis}
    ...
    \label{ssub:question_3}
      ...
      Given how different listening habits of users can be, some like to just have an automatic generated playlist playing in the background, wherein others might like to listen to an artist's albums in sequence. \\
    ...
    \label{ssub:question_4}
      ...
      This might indicate that the current way of performing this action, might be too work on the user.
