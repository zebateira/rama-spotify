...
\label{sec:related_similar_services}
  ...
  \label{sub:liveplasma}
    ...
    In Figure~\ref{fig:sota_liveplasma} one can see the search result for "Amália Rodrigues".
    ...
    \label{ssub:liveplasma_cons}
      ...
      One critical detail is that the user cannot visually point out the search node in the graph, given the lack of visual distinction from the other nodes of the graph (Figure~\ref{fig:sota_liveplasma}).
  ...
  \label{sub:tuneglue}
    ...
    \begin{figure}[H]
      \begin{center}
        \includegraphics[width=0.5\textwidth]{tuneglue2.pdf}
      \end{center}
  ...
  \label{sub:musicroamer}
    ...
    \label{ssub:pros}
      ...
      \begin{figure}[H]
        \begin{center}
          \includegraphics[width=0.5\textwidth]{musicroamer3.pdf}
        \end{center}
      ...
      \begin{figure}[H]
        \begin{center}
          \includegraphics[width=0.6\textwidth]{musicroamer2.pdf}
        \end{center}
...
\section{Summary}
  ...
  There are an uncountable number of services to discover new music.
