...
\section{Summary}
  ...
  The most important aspect to retain from the previous examples is that the bigger the visualization parameters (branching and depth) of the graph, the more confusing and cluttered the graph becomes.
