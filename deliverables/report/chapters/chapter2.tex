...
\label{sub:musicroamer}
  ...
  In \ref{fig:sota_musicroamer3} one can see the search result for "Mariza".

  The images of the music artists are used to represent the nodes. This way, the user have a mind map of the resulting graph.
