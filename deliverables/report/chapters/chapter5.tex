...
\label{sec:future_work}
  ...
  To improve this, one could fully use Echonest's API to fetch the similar artists\footnote{similar artists query using Echonest's API: \url{http://developer.echonest.com/docs/v4/artist.html\#similar}}.
