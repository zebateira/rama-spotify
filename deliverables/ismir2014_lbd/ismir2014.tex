...
\end{abstract}
  ...
  \label{sec:spotify_tools}
    ...
    Spotify\footnote{\url{http://spotify.com}} provides several features to allow users to discover new music such as \textit{Browse, Activity, Discovery, Radio} and \textit{Spotify Apps}.
  ...
  \label{sec:rama}
    ...
    While there are other visual-based recommendation applications (e.g., MusicRoamer\cite{musicroamer} and Liveplasma\cite{liveplasma}).
