...
%  {Fabien Gouyon, Matthew Davies, Marcelo Caetano} {Sound and Music Computing Group, INESC TEC \\ {\tt \{fgouyon,mdavies,mcaetano\}@inesctec.pt}}
...
\end{abstract}
  ...
  % A visual tool inside a complete service like Spotify improves user experience when discovering new music.

  \section{Main Features} % (fold)
  \label{sec:features}

    % This demo shows the main implemented features of RAMA's Spotify App.
