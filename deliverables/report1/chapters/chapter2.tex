...
\label{sub:musicroamer}
  ...
  Umas das funcionalidades mais interessantes do MusicRoamer são as várias opções que temos de pesquisa (figura \ref{fig:sota_musicroamer}):
  ...
  \begin{figure}[tb]
    \begin{center}
      \includegraphics[]{musicroamer.pdf}
    \end{center}
