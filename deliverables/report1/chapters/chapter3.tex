...
\label{sec:spotify}
  ...
  \label{sub:experimentacoes}
    ...
    Numa primeira experiência com as ferramentas, foi criado um pequeno \emph{website} que permite pesquisar e ouvir Música do Spotify que usa a \emph{Metadata API} e \emph{Spotify Widgets} : \\
